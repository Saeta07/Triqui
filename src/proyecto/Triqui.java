...
(matriz de 3x3, hay una jugada por turno, se tienen que ubicar tres fichas iguales en linea diagonal o horizonal o vertical hasta que llene el tablero o alguien gane)
...
public class Triqui {
    ...
    public static void jugar() {
        ...
        // turno actual -*-  true = jugador1, false = jugador2
        boolean turno = true;
        ...
        int fila, columna;
        boolean posicionCorrecta, correcto;
        ...
        while (!finPartida(tablero, vacio)) {
            ...
            do {
                ...
                correcto = false;
                fila = pedirInteger("Que fila deseas jugar ? ");
                columna = pedirInteger("Que columna deseas jugar ?");

                // Validamos la posicion
                posicionCorrecta = validarPosicion(tablero, fila, columna);
            ...
            if (turno) {
                insertarEn(tablero, fila, columna, jugador1);
            } else {
                insertarEn(tablero, fila, columna, jugador2);
            }
     ...
     * @param simDef
     */
    public static void mostrarGanador(char[][] matriz, char jugador1, char jugador2, char simDef) {

        char simbolo = coincidenciaLinea(matriz, simDef);

        if (simbolo != simDef) {

            ganador(simbolo, jugador1, jugador2, 1);
        ...
        if (simbolo != simDef) {
            ...
            ganador(simbolo, jugador1, jugador2, 2);
        ...
        if (simbolo != simDef) {
            ...
            ganador(simbolo, jugador1, jugador2, 3);
     ...
     * @param tipo
     */
    public static void ganador(char simbolo, char jugador1, char jugador2, int tipo) {
